...
while vitoria == False and morte == False and personagem_ficha["energia"] > 0: 
        print(f'\n seus status atual: {personagem_ficha}\n')
        print(capitulos[cap])
        ...
        if capitulos[cap] == cap39: #mosca
            ...
            combate.encontrou_inimigo(personagem, inimigo_atual)
        ...
        if capitulos[cap] == cap45:
            ...
            if personagem_ficha["energia"] <= 0:
                print('você está morto')
                break 
        # if capitulos[cap] == cap51: hobglobinSegundo hab6 energ5
        ...
        if capitulos[cap] == cap84:
            ...
            if soma > 8:
                ...
                print('vá para 121')
        # if capitulos[cap] == cap84: orca1 hab5 enrg5 // orca2 bah6 enrg4
